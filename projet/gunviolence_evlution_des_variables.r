...
getwd()
setwd("/home/asus/Desktop/work/M1_MATHS/Projet-R")
...
allData <- read.table("ressources/gun-violence-data_01-2013_03-2018.csv", sep = ",", header=FALSE, skip = 1, skipNul = TRUE, fill = TRUE, quote = "", strip.white = TRUE )
